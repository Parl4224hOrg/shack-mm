...
import {Client, Guild, ChannelType, Collection, TextChannel} from "discord.js";
...
import {GameData, InternalResponse} from "./Internal";
import {acceptScore, initialSubmit} from "../views/submitScoreViews";
