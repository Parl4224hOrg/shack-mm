...
export default {
    ...
    PostMatchVoiceChannel: "1521992520819802224",
    ...
    Ranks: [
        {name: 'Grandmaster', threshold: 2500, max: 1000000, roleId: '1285641380600877157'}, // 10
        ...
        {name: 'Iron', threshold: 1250, max: 1349, roleId: '1152692103256744086'}, // 3
        {name: 'Copper', threshold: 1150, max: 1249, roleId: '1152659149017075894'}, // 2
