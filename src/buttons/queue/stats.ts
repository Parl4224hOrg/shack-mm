...
export const stats: Button = {
    ...
    run: async (interaction, data) => {
        try {
            ...
            await interaction.reply({flags: MessageFlagsBitField.Flags.Ephemeral, embeds: [statsEmbed(stats, dbUser, interaction.user.username,  interaction.user.avatarURL()!)]});
        } catch (e) {
