...
export const readyEU15: Button = {
    data: new ButtonBuilder()
        .setLabel('EU-15')
        .setCustomId('snd-ready-button-EU-15')
    ...
    id: 'snd-ready-button-EU-15',
}

export const readyEU30: Button = {
    data: new ButtonBuilder()
        .setLabel('EU-30')
        .setCustomId('snd-ready-button-EU-30')
        .setStyle(ButtonStyle.Success),
    run: async (interaction, data) => {
        try {
    ...
    id: 'snd-ready-button-EU-30',
}

export const readyEU60: Button = {
    data: new ButtonBuilder()
        .setLabel('EU-60')
        .setCustomId('snd-ready-button-EU-60')
        .setStyle(ButtonStyle.Success),
    run: async (interaction, data) => {
        try {
    ...
    id: 'snd-ready-button-EU-60',
}

export const readyEU120: Button = {
    data: new ButtonBuilder()
        .setLabel('EU-120')
        .setCustomId('snd-ready-button-EU-120')
        .setStyle(ButtonStyle.Success),
    run: async (interaction, data) => {
        try {
