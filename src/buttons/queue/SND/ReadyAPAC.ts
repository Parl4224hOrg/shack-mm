...
export const readyAPAC15: Button = {
    data: new ButtonBuilder()
        .setLabel('APAC-15')
        .setCustomId('snd-_ready-button-APAC-15')
    ...
    id: 'snd-_ready-button-APAC-15',
}

export const readyAPAC30: Button = {
    data: new ButtonBuilder()
        .setLabel('APAC-30')
        .setCustomId('snd-_ready-button-APAC-30')
        .setStyle(ButtonStyle.Success),
    run: async (interaction, data) => {
        try {
    ...
    id: 'snd-_ready-button-APAC-30',
}

export const readyAPAC60: Button = {
    data: new ButtonBuilder()
        .setLabel('APAC-60')
        .setCustomId('snd-_ready-button-APAC-60')
        .setStyle(ButtonStyle.Success),
    run: async (interaction, data) => {
        try {
    ...
    id: 'snd-_ready-button-APAC-60',
}

export const readyAPAC120: Button = {
    data: new ButtonBuilder()
        .setLabel('APAC-120')
        .setCustomId('snd-_ready-button-APAC-120')
        .setStyle(ButtonStyle.Success),
    run: async (interaction, data) => {
        try {
