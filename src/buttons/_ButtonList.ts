...
import {abandonConfirm} from "./match/abandon/abandonConfirm";
import {graphButton} from "./queue/graph";
import {ratingChangeButton} from "./queue/ratingChange";
...
pingMeButton, autoReady, checkBanButton, abandonButton, abandonDeny, abandonConfirm, graphButton, ratingChangeButton,
    ...
    promptResetGame, confirmResetGame, cancelResetGame, updateInfo, resubmit];
